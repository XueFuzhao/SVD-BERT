...
JOB_NAME=only_part_svd_moe_pretraining_lr2e_4_bs32k_offset0_epoch160
...
--cf ${base_dir}/part_bert_base_SVD.json \
--max_seq_length 512 \
...
--lr_offset 0.0 \
--job_name $JOB_NAME \
--deepspeed_config part_deepspeed_bsz16_lamb_config_seq512.json \
