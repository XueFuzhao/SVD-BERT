LOG_DIR="/home/users/nus/e0792473/scratch/outputs/log"
if [ ! -d "$LOG_DIR" ]; then
  mkdir $LOG_DIR
fi
...
run_cmd="python -m torch.distributed.launch \
       ...
       --output_dir ${OUTPUT_DIR}_${TASK} &> $LOG_DIR/${model_name}/${JOBNAME}_${TASK}_bzs${EFFECTIVE_BATCH_SIZE}_lr${LR}_epoch${NUM_EPOCH}_baseline.txt
       "
echo ${run_cmd}
eval ${run_cmd} 
